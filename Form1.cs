...
namespace UHFReader288Demo
{
    public partial class Form1 : Form
    {
        ...
        protected override void DefWndProc(ref Message m)
        {
            ...
            else if (m.Msg == WM_MIXTAG)
            {
                ...
                if (flagset)
                {
                    ...
                    dataGridView1.Columns["Column9"].HeaderText = "Freq(khz)";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //table.Columns.Add("Information", Type.GetType("System.String"));
            //dataGridView1_Test.DataSource = table;
            ...
            //com_scantime_Test.SelectedIndex = 50;//--------
            ...
            ComboBox_PowerDbm.SelectedIndex = 27;
            ComboBox_PowerDbmMin.SelectedIndex = 27;
            ComboBox_PowerDbmMax.SelectedIndex = 33;
            ComboBox_PowerDbm_Step.SelectedIndex = 3;
            ...
            com_MixMem_Test.SelectedIndex = 2;
        ...
        {
            dataGridView1.DataSource = null;
            dataGridView_Miss_Data.DataSource = null;
            dataGridView_External.DataSource = null;
            dataGridView_Readable_Data.DataSource = null;
            dataGridView_Miss_Data.Rows.Clear();
            dataGridView_External.Rows.Clear();
            dataGridView_Readable_Data.Rows.Clear();

            timerSetPowerDbm.Stop();
            ////应答模式下刷屏
        ...
        private void btIventoryG2_Click(object sender, EventArgs e)
        {
            ...
            {
                if (radioExpandDbm.Checked)
                {
                    byte powerDbmMin = (byte)ComboBox_PowerDbmMin.SelectedIndex;
                    byte powerDbmMax = (byte)ComboBox_PowerDbmMax.SelectedIndex;
                    byte powerDbmStep = (byte)ComboBox_PowerDbm_Step.SelectedIndex;
                    powerDbmCurrent = powerDbmMin;

                    if (powerDbmMax > powerDbmMin)
                    {
                        fCmdRet = RWDev.SetRfPower(ref fComAdr, powerDbmCurrent, frmcomportindex);
                        if (fCmdRet != 0)
                        {
                            string strLog = "Set power" + powerDbmCurrent + " failed: " + GetReturnCodeDesc(fCmdRet);
                            WriteLog(lrtxtLog, strLog, 1);
                        }
                        else
                        {
                            string strLog = "Set power " + powerDbmCurrent + "  success ";
                            WriteLog(lrtxtLog, strLog, 0);
                        }
                    }
                    ...
                    if (powerDbmStep > 0)
                    {
                        timerSetPowerDbm.Interval = Convert.ToInt32(txtTimeStep.Text) * 1000;
                        timerSetPowerDbm.Start();
                    }
                }

                dataGridView_Miss_Data.Rows.Clear();
                dataGridView_Miss_Data.Columns.Clear();
                dataGridView_Miss_Data.Columns.Add("No", "No");
                dataGridView_Miss_Data.Columns.Add("EPC", "EPC");
                dataGridView_Miss_Data.Columns.Add("Information", "Information");
                dataGridView_Miss_Data.Columns["EPC"].Width = 200;
                dataGridView_Miss_Data.Columns["Information"].Width = 200;

                dataGridView_Readable_Data.Rows.Clear();
                dataGridView_Readable_Data.Columns.Clear();
                dataGridView_Readable_Data.Columns.Add("No", "No");
                dataGridView_Readable_Data.Columns.Add("EPC", "EPC");
                dataGridView_Readable_Data.Columns.Add("Information", "Information");
                dataGridView_Readable_Data.Columns.Add("Count", "Count");
                dataGridView_Readable_Data.Columns["EPC"].Width = 200;
                dataGridView_Readable_Data.Columns["Information"].Width = 200;

                dataGridView_External.Rows.Clear();
                dataGridView_External.Columns.Clear();
                dataGridView_External.Columns.Add("No", "No");
                dataGridView_External.Columns.Add("EPC", "EPC");
                dataGridView_External.Columns["EPC"].Width = 200;

                timer_campare.Interval = 500;
                timer_campare.Start();

                if (rb_mix.Checked)
                {
                    ReadMem = (byte)com_MixMem_Test.SelectedIndex;
            ...
            while (!toStopThread)
            {
                ...
                catch (System.Exception ex)
                {
                    this.Invoke((EventHandler)delegate
                    {
                       ...
                       // WriteToExcel(dataGridView1, filePath);
                    });
                }
        ...
        private void btGetInformation_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                    ...
                    || ReaderType == 0x66 || ReaderType == 0x65 || ReaderType == 0x67 || ReaderType == 0x68)//C6
                {
                    ...
                    || ReaderType == 0x40 || ReaderType == 0x41 || ReaderType == 0x42//大功率
                ...
                if (powerdBm < 37)
                    ComboBox_PowerDbmMin.SelectedIndex = Convert.ToInt32(powerdBm);
                else
                {
        ...
        private void BT_DBM_Click(object sender, EventArgs e)
        {
            if (radioExpandDbm.Checked)
            {
                ...
                if (powerDbmMax > powerDbmMin)
                {
                    ...
                    if (fCmdRet != 0)
                    {
                        lxLedControlDbm.Text = powerDbmCurrent.ToString();
                        string strLog = "Set power" + powerDbmCurrent + " failed: " + GetReturnCodeDesc(fCmdRet);
                        WriteLog(lrtxtLog, strLog, 1);
                    }
                    else
        ...
        {
            com_MixMem_Test.Items.Clear();
            if (mtype == 0)
            {
                com_MixMem_Test.Items.Add("Reserve");
                com_MixMem_Test.Items.Add("EPC");
                com_MixMem_Test.Items.Add("TID");
                com_MixMem_Test.Items.Add("User");
                com_MixMem_Test.SelectedIndex = 2;
                R_EPC.Text = "EPC";
                R_TID.Text = "TID";
                P_EPC.Text = "EPC";
            ...
            {
                com_MixMem_Test.Items.Add("Reserve");
                com_MixMem_Test.Items.Add("MUII");
                com_MixMem_Test.Items.Add("CID");
                com_MixMem_Test.Items.Add("User");
                com_MixMem_Test.SelectedIndex = 2;
                R_EPC.Text = "MUII";
                R_TID.Text = "CID";
        ...
        private void button24_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Not Select device!", "Error");
                }
            }
            catch (Exception ex)
            {
        ...
        {
            text_infor_Scan.Text = String.Empty;

            if (text_infor_Scan.Text == "")
            {
                MessageBox.Show("Please enter Information Product");
                text_infor_Scan.Focus();
                return;
        ...
        private void btn_Export_to_Excel(object sender, EventArgs e)
        {
        ...
        private void Main_Page2_Click(object sender, EventArgs e)
        {
        ...
        private void btSet_Test_Click(object sender, EventArgs e)
        {

        }

        private void btSet_Test_Click_1(object sender, EventArgs e)
        {
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (op.ShowDialog() == DialogResult.OK)
                {
                    ...
                    string con = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source={0};Extended Properties='Excel 12.0 Xml;HDR=YES;'";
                    ...
                    using (OleDbConnection excelconnection = new OleDbConnection(con))
                    {
                        ...
                        using (OleDbCommand com = new OleDbCommand("SELECT * FROM [" + excelsheet + "]", excelconnection))
                        {
                            using (OleDbDataAdapter oda = new OleDbDataAdapter(com))
                            {
                                oda.Fill(dataTest);
                            }
                        }
                    }
                    dataGridView1_Test.DataSource = dataTest;
                }
            }
            catch (Exception ex)
            {
        ...
        {
            HashSet<string> epcsInDgv1 = new HashSet<string>();
            ...
            HashSet<string> epcsInDgv2 = new HashSet<string>();

            foreach (DataGridViewRow row in dataGridView1_Test.Rows)
            {
                if (row.Cells[1].Value != null)
                {
                    string epc = row.Cells[1].Value.ToString();
            ...
            foreach (DataGridViewRow row in dataGridView1_Test.Rows)
                ...
                {
                    string epc = row.Cells[1].Value.ToString();
                    string information = row.Cells[2].Value != null ? row.Cells[2].Value.ToString() : "";
                    
                    if (!epcsInDgv1.Contains(epc)) 
                    {
                
                        dataGridView_Miss_Data.Rows.Add(missDataNum, epc, information);
                        missDataNum++;
                    }
                    else {

                        myArray[ctn] = information;
                        ctn++;
                    }
            ...
            foreach (DataGridViewRow row in dataGridView1.Rows)
            {
                    ...
                    // Kiểm tra để tránh lỗi ở hàng cuối cùng (nếu có)
                    if (row.Cells[1].Value != null)
                {
                    string epc = row.Cells[1].Value.ToString();
                    string information = row.Cells[2].Value != null ? row.Cells[2].Value.ToString() : "";
                    string count = row.Cells[2].Value.ToString();
                    if (!epcsInDgv2.Contains(epc)) // Nếu EPC không có trong dataGridView1_Test
                    {
                        // thêm nó vào dataGridView_External
                        dataGridView_External.Rows.Add(externalNum, epc);
                        externalNum++; // Tăng số thứ tự cho hàng tiếp theo trong dataGridView_External
                    }
                    else
                    {
                       
                        dataGridView_Readable_Data.Rows.Add(ReadableNum, epc, myArray[ReadableNum], count);
                        ReadableNum++;
                    }

                }
            }
            //string strLog = "Completed compare ";
            //WriteLog(lrtxtLog, strLog, 0);
        }

        private void timerSetPowerDbm_Tick(object sender, EventArgs e)
        {
            byte powerDbmMin = (byte)ComboBox_PowerDbmMin.SelectedIndex;
            byte powerDbmMax = (byte)ComboBox_PowerDbmMax.SelectedIndex;
            byte powerDbmStep = (byte)ComboBox_PowerDbm_Step.SelectedIndex;
            if (powerDbmCurrent == powerDbmMax)
            {
                timerSetPowerDbm.Stop();
            }
            else
            {
                powerDbmCurrent =(byte)(powerDbmCurrent + powerDbmStep);
                fCmdRet = RWDev.SetRfPower(ref fComAdr, powerDbmCurrent, frmcomportindex);
                if (fCmdRet != 0)
                {
                    lxLedControlDbm.Text = powerDbmCurrent.ToString();
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable dataTest1 = new DataTable();
                OpenFileDialog op = new OpenFileDialog();
                op.Filter = "Excel Sheet(*.xlsx)|*.xlsx|All Files(*.*) | *.* ";
                if (op.ShowDialog() == DialogResult.OK)
                {
                    ...
                    dataGridView1.DataSource = dataTest1;
                }
            }
            catch (Exception ex)
            {
        ...
        private void rb_enable_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void timer_campare_Tick(object sender, EventArgs e)
        {
            CompareTag();
        }
    }
